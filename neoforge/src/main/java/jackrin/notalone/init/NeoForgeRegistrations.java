...
public class NeoForgeRegistrations {
    ...
    public static final Supplier<EntityType<NotAloneEntity>> NOT_ALONE_ENTITY =
            ENTITY_TYPES.register("notalone_entity", () -> {
                EntityType<NotAloneEntity> entityType = EntityType.Builder.of(
                                NotAloneEntity::new,
                                MobCategory.MISC
                        )
                        .sized(0.6F, 1.8F)
    ...
    public static class ServerEvents {
        ...
        public static void onRegisterLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {
            event.registerLayerDefinition(NotAloneEntityModel.ENTITY, NotAloneEntityModel::createLayerDefinition);
        }
